...
export default function ScreeningSection() {
  ...
  return (
    <section className='flex w-full flex-col md:flex-row'>
      <article
        className={`from-secondary-green to-primary-green flex w-full flex-col items-center justify-center bg-gradient-to-b px-4 py-8 text-justify text-base md:w-1/2 md:px-8 md:text-xl lg:px-12 lg:text-2xl ${
          isMobile ? 'min-h-[400px] pb-12' : 'min-h-screen'
        }`}
      >
        <p className='mb-4'>
